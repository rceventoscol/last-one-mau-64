...
export const Clients = () => {
  ...
  return (
    <section id="clientes" className="py-16 md:py-24 bg-gradient-to-b from-secondary/10 to-white">
      <div className="container px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 font-playfair text-gray-900">
            Ellos ya vivieron la experiencia Tierra Fértil
          </h2>
          ...
          <div className="relative h-[480px] rounded-xl overflow-hidden shadow-lg">
            {clients.map((client, index) => (
              <div 
                key={client.id} 
                className={cn(
                  "absolute inset-0 flex flex-col md:flex-row transition-all duration-700",
                  index === activeIndex 
