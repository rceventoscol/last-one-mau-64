...
export const Brands = () => {
  ...
  return <section id="marcas" className="py-16 md:py-24 bg-gray-50">
      <div className="container px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center font-playfair text-gray-900">Ellos ya vivieron la experiencia Tierra Fértil</h2>
        
        {/* Brands carousel */}
        <div className="relative overflow-hidden max-w-6xl mx-auto" ref={slidesRef}>
          <div className="flex flex-wrap justify-center gap-8">
            {brands.map((brand, index) => <div key={brand.id} className={cn("transition-all duration-700 w-full sm:w-[calc(50%-1rem)] md:w-[calc(33.33%-1.5rem)]", activeSlides.includes(index) ? "opacity-100 scale-100" : "opacity-0 scale-95 absolute")}>
