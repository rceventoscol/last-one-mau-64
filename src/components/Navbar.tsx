...
export const Navbar = () => {
  ...
  return (
    ...
    >
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {[
              ...
              <button
                ...
                className={cn(
                  "font-poppins text-sm font-medium transition-colors relative",
                  isScrolled 
      ...
      <div 
        className={cn(
          "md:hidden absolute top-full left-0 right-0 overflow-hidden transition-all duration-300 bg-white shadow-lg",
        ...
        <div className="px-4 py-4 space-y-2">
          {[
            ...
            <div key={item.id} className="border-b border-gray-100 last:border-0">
              <button
                onClick={() => scrollToSection(item.id)}
                className="w-full text-left py-3 px-2 font-poppins text-gray-700 hover:text-primary transition-colors"
              >
                {item.name}
              </button>
            </div>
